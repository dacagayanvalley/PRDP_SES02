...
export function AppShell({ children, page, setPage, role, setRole, onExport, onReset, toast }: Props) {
  return (
      ...
      <main>
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <button className="ghost" onClick={onReset}>Reload demo</button>
          </div>
        </header>
        <section className="warning" role="note">
          GitHub Pages static MVP: use synthetic or non-sensitive local data only. RBAC, audit and confidentiality controls are workflow simulations until a backend is approved.
        </section>
